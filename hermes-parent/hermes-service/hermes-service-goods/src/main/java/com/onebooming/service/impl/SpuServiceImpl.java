...
import com.onebooming.goods.pojo.*;
import com.onebooming.service.SpuService;
...
public class SpuServiceImpl implements SpuService {
    ...
    public void saveGoods(Goods goods) {
        ...
        for (Sku sku : skus) {
            ...
            //将规格转换成Map
            //spec的数据类型为String，举例字符串格式为{"屏幕":"视网膜屏","内存":"8G","存储":"256G","网络":"联通5G","处理器":"晓龙865","价格":"5699"}
    ...
    /**
     * 删除:存在bug，删除商品的同时应该是将该商品的SPU和SKU都删除
     *
     * @param id
     */
    @Override
