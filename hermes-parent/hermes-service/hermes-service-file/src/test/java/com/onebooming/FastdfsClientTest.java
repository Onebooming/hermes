...
public class FastdfsClientTest {
    ...
    public void upload() throws Exception {
        ...
        //加载全局的配置文件
        ClientGlobal.init("/Users/chenglei/Desktop/java/IDEAWorkstation/hermes/hermes-parent/hermes-service/hermes-service-file/src/main/resources/fdfs_client.conf");
        ...
        //执行文件上传
        String[] jpgs = storageClient.upload_file("/Users/chenglei/Desktop/蓝底证件照.jpg", "jpg", null);
    ...
    public void download() throws Exception {
        ...
        StorageClient storageClient = new StorageClient(trackerServer, null);
        //执行文件上传
        byte[] bytes = storageClient.download_file("group1", "/M00/00/00/rBAKyF4_-46ASEfGAACWyxhOGLM262.jpg");

        File file = new File("/Users/chenglei/Desktop/download.jpg");
